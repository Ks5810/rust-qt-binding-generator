...
pub struct TimeEmitter {
    ...
    hour_changed: fn(*mut TimeQObject),
    minute_changed: fn(*mut TimeQObject),
    second_changed: fn(*mut TimeQObject),
}
...
pub extern "C" fn time_new(
    ...
    time_hour_changed: fn(*mut TimeQObject),
    time_minute_changed: fn(*mut TimeQObject),
    time_second_changed: fn(*mut TimeQObject),
) -> *mut Time {
